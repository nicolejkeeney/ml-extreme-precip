"""Code for building and tuning CNN 
...
def build_kt_tuning_model(hp):
    ...
    activity_reg = hp.Float(
        "activity_reg", min_value=0.0001, max_value=0.1, step=10, sampling="log"
    )
    conv_filters = hp.Int("conv_filters", min_value=8, max_value=32, step=8)
    dense_neurons = hp.Int("dense_neurons", min_value=8, max_value=32, step=8)
